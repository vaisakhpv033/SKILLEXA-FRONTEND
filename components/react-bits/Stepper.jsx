...
export default function Stepper({
  ...
  return (
    <div
      className="flex flex-1 flex-col items-center justify-center p-4 min-h-fit"
      {...rest}
    >
      <div
...
export function Step({ children }) {
  return <div className="px-2 lg:px-8">{children}</div>;
}
    ...
    >
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: "#6c28d9", color: "#6c28d9" },
          complete: { scale: 1, backgroundColor: "#6c28d9", color: "#3b82f6" },
        }}
...
function StepConnector({ isComplete }) {
  const lineVariants = {
    ...
    complete: { width: "100%", backgroundColor: "#6c28d9" },
  };
