...
const StudentRegistrationForm = () => {
    ...
    debounce((field, value) => {
      ...
      switch (field) {
        ...
        case 'password':
          ...
          if (!criteria.length) passwordErrors.push('Password must be 8-20 characters long');
          if (!criteria.uppercase) passwordErrors.push('Include at least one uppercase letter');
          if (!criteria.lowercase) passwordErrors.push('Include at least one lowercase letter');
          if (!criteria.number) passwordErrors.push('Include at least one number');
          if (!criteria.special) passwordErrors.push('Include at least one special character');
  ...
  const handleSubmit = async (e) => {
    ...
    const allFields = ['firstName', 'lastName', 'username', 'email', 'password', 'confirmPassword'];
      ...
      <div className="mt-2 space-y-1">
        {criteria.map((criterion, index) => (
          <div key={index} className="flex items-center gap-1 text-sm">
            ...
            <span className={criterion.met ? 'text-green-500' : 'text-gray-500'}>
              {criterion.label}
            </span>
          </div>
        ))}
  ...
  return (
    <>
      <form onSubmit={handleSubmit} 
            ...
            <div className="relative">
              ...
              <input
                ...
                className={cn(
                  ...
                  errors.firstName && touchedFields.has('firstName') && "border-red-500 dark:border-red-500"
                )}
            ...
            <div className="relative">
              ...
              <input
                ...
                className={cn(
                  ...
                  "focus:ring-2 focus:ring-custom-gradient-start focus:border-transparent",
                  "transition-colors duration-200",
                  errors.lastName && touchedFields.has('lastName') && "border-red-500 dark:border-red-500"
                )}
            ...
            <div className="relative">
              ...
              <input
                ...
                className={cn(
                  ...
                  "focus:ring-2 focus:ring-custom-gradient-start focus:border-transparent",
                  "transition-colors duration-200",
                  errors.username && touchedFields.has('username') && "border-red-500 dark:border-red-500"
                )}
            ...
            <div className="relative">
              ...
              <input
                ...
                className={cn(
                  ...
                  "focus:ring-2 focus:ring-custom-gradient-start focus:border-transparent",
                  "transition-colors duration-200",
                  errors.email && touchedFields.has('email') && "border-red-500 dark:border-red-500"
                )}
            ...
            <div className="relative">
              ...
              <input
                ...
                className={cn(
                  ...
                  "focus:ring-2 focus:ring-custom-gradient-start focus:border-transparent",
                  "transition-colors duration-200",
                  errors.password && touchedFields.has('password') && "border-red-500 dark:border-red-500"
                )}
            ...
            <div className="relative">
              ...
              <input
                ...
                className={cn(
                  ...
                  "focus:ring-2 focus:ring-custom-gradient-start focus:border-transparent",
                  "transition-colors duration-200",
                  errors.confirmPassword && touchedFields.has('confirmPassword') && "border-red-500 dark:border-red-500"
                )}
        ...
        {error && <p className='text-red-500 dark:text-red-500 text-center font-semibold'>*{error}</p>} {/* Show the error */}
