...
export async function GET(req) {
    try {
        ...
        const apiUrl = `${API_BASE_URL}/course/comments/?course=${courseId}`
        ...
        console.error("Discussion fetching error:", error?.response?.data || error.message);

        const errorMessage = error?.response?.data?.error || "messages fetching failed. Please try again later.";
...
export async function POST(req) {
    try {
        ...
        const response = await axios.post(`${API_BASE_URL}/course/comments/`, body, {
            headers: {
                Authorization: `Bearer ${session.accessToken}`,
        ...
        console.error("Comment adding Error:", error?.response?.data || error.message);
